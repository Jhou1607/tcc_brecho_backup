    ...
    public function run(): void
    {
        ...
        foreach ($produtos as $produtoData) {
            Produto::create(array_merge($produtoData, [
                'modelo' => fake()->word(),
                'estado_conservacao' => fake()->randomElement(['novo', 'seminovo', 'usado']),
                'estacao' => fake()->randomElement(['verao', 'outono', 'inverno', 'primavera', 'todas']),
                'numeracao' => fake()->randomElement(['P', 'M', 'G', 'GG', '36', '38', '40', '42', '44', '46']),
                'ocasioes' => fake()->randomElements(['trabalho', 'festa', 'casual', 'esporte', 'praia', 'balada', 'dia a dia'], fake()->numberBetween(1, 3)),
                'estilos' => fake()->randomElements(['classico', 'moderno', 'boho', 'minimalista', 'rocker', 'romantico', 'esportivo', 'urbano', 'vintage'], fake()->numberBetween(1, 3)),
                'material' => fake()->randomElement(['algodao', 'linho', 'la', 'seda', 'jeans', 'couro', 'moletom', 'viscose', 'poliester']),
            ]));
        }
